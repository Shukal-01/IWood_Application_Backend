...
const add = async (req, res) => {
  try {
    handleCreate(req, res, productionHouseContentTypesModel, [], {}, "");
  } catch (error) {
...
const get = async (req, res) => {
  try {
    handleGet(req, res, productionHouseContentTypesModel, {});
  } catch (error) {
    return sendError(res, 404, error.message);
  }
};
...
const deleteData = async (req, res) => {
  try {
    handleDelete(req, res, productionHouseContentTypesModel, {
...
const updateDate = async (req, res) => {
  try {
    handleUpdate(req, res, productionHouseContentTypesModel, [], {}, "", {
      _id: req.params.itemId,
    });
  } catch (error) {
    return sendError(res, 404, error.message);
...
const productionHouseContentTypeController = {
  add,
  get,
  deleteData,
  updateDate,
...
export default productionHouseContentTypeController;
