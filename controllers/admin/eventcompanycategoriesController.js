...
const add = async (req, res) => {
  try {
    handleCreate(req, res, EventCompanyCategories, [], {}, "");
  } catch (error) {
...
const get = async (req, res) => {
  try {
    handleGet(req, res, EventCompanyCategories, {});
  } catch (error) {
    return sendError(res, 404, error.message);
  }
};
...
const deleteData = async (req, res) => {
  try {
    handleDelete(req, res, EventCompanyCategories, { _id: req.params.itemId });
  } catch (error) {
    return sendError(res, 404, error.message);
  }
};
...
const updateDate = async (req, res) => {
  try {
    handleUpdate(req, res, EventCompanyCategories, [], {}, "", {
...
const eventCompanyCategoriesController = { add, get, deleteData, updateDate };

export default eventCompanyCategoriesController; 