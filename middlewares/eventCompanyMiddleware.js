...
// Access config var
let accessToken = process.env.TOKEN_SECRET_EVENT_COMPANY;
...
const eventCompanyMiddleware = { authenticateToken, generateAccessToken, getUserData };

export default eventCompanyMiddleware;
